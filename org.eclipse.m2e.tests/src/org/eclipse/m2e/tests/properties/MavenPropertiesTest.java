...
public class MavenPropertiesTest extends AbstractMavenProjectTestCase {
  ...
  public void testResolverIO() throws Exception {
    project = importProject("projects/properties_project/dependency/pom.xml");
    ...
    resolverConfiguration.setProperties(testProperties);

    ResolverConfigurationIO.saveResolverConfiguration(project, resolverConfiguration);

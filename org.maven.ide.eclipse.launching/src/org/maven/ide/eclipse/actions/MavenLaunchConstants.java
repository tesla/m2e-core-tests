...
public interface MavenLaunchConstants {
    ...
    public final String LAUNCH_CONFIGURATION_TYPE_ID = "org.maven.ide.eclipse.Maven2LaunchConfigurationType"; //$NON-NLS-1$
    public final String BUILDER_CONFIGURATION_TYPE_ID = "org.maven.ide.eclipse.Maven2BuilderConfigurationType"; //$NON-NLS-1$

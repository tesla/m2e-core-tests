 ...
 * <ul>
 * <li>{@link org.maven.ide.components.pom.Reporting#getExcludeDefaults <em>
 * Exclude Defaults</em>}</li>
 * <li>{@link org.maven.ide.components.pom.Reporting#getOutputDirectory <em>
 * Output Directory</em>}</li>
 * <li>{@link org.maven.ide.components.pom.Reporting#getPlugins <em>Plugins
 * </em>}</li>
 * </ul>
 * </p>
 * 
 * @see org.maven.ide.components.pom.PomPackage#getReporting()
...
public interface Reporting extends EObject {
	 ...
	 * @see org.maven.ide.components.pom.PomPackage#getReporting_ExcludeDefaults()
	 ...
	 * @see org.maven.ide.components.pom.PomPackage#getReporting_OutputDirectory()
	 ...
	 * @see #isSetPlugins()
	 * @see #unsetPlugins()
	 * @see org.maven.ide.components.pom.PomPackage#getReporting_Plugins()
	...
	/**
	 * Unsets the value of the '
	 * {@link org.maven.ide.components.pom.Reporting#getPlugins

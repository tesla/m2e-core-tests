 ...
 * <ul>
 * <li>{@link org.maven.ide.components.pom.impl.BuildBaseImpl#getDefaultGoal
 * <em>Default Goal</em>}</li>
 * <li>{@link org.maven.ide.components.pom.impl.BuildBaseImpl#getResources <em>
 * Resources</em>}</li>
 * <li>{@link org.maven.ide.components.pom.impl.BuildBaseImpl#getTestResources
 * <em>Test Resources</em>}</li>
 * <li>{@link org.maven.ide.components.pom.impl.BuildBaseImpl#getDirectory <em>
 * Directory</em>}</li>
 * <li>{@link org.maven.ide.components.pom.impl.BuildBaseImpl#getFinalName <em>
 * Final Name</em>}</li>
 * <li>
 * {@link org.maven.ide.components.pom.impl.BuildBaseImpl#getPluginManagement
 * <em>Plugin Management</em>}</li>
 * <li>{@link org.maven.ide.components.pom.impl.BuildBaseImpl#getPlugins <em>
 * Plugins</em>}</li>
 * <li>{@link org.maven.ide.components.pom.impl.BuildBaseImpl#getFilters <em>
 * Filters</em>}</li>
 * </ul>
 * </p>
 * 

 ...
 * <ul>
 * <li>{@link org.maven.ide.components.pom.impl.BuildImpl#getSourceDirectory
 * <em>Source Directory</em>}</li>
 * <li>
 * {@link org.maven.ide.components.pom.impl.BuildImpl#getScriptSourceDirectory
 * <em>Script Source Directory</em>}</li>
 * <li>
 * {@link org.maven.ide.components.pom.impl.BuildImpl#getTestSourceDirectory
 * <em>Test Source Directory</em>}</li>
 * <li>{@link org.maven.ide.components.pom.impl.BuildImpl#getOutputDirectory
 * <em>Output Directory</em>}</li>
 * <li>
 * {@link org.maven.ide.components.pom.impl.BuildImpl#getTestOutputDirectory
 * <em>Test Output Directory</em>}</li>
 * <li>{@link org.maven.ide.components.pom.impl.BuildImpl#getExtensions <em>
 * Extensions</em>}</li>
 * </ul>
 * </p>
 * 

...
import org.maven.ide.components.pom.DocumentRoot;
 ...
 * <ul>
 * <li>{@link org.maven.ide.components.pom.impl.DocumentRootImpl#getMixed <em>
 * Mixed</em>}</li>
 * <li>
 * {@link org.maven.ide.components.pom.impl.DocumentRootImpl#getXMLNSPrefixMap
 * <em>XMLNS Prefix Map</em>}</li>
 * <li>
 * {@link org.maven.ide.components.pom.impl.DocumentRootImpl#getXSISchemaLocation
 * <em>XSI Schema Location</em>}</li>
 * <li>{@link org.maven.ide.components.pom.impl.DocumentRootImpl#getProject <em>
 * Project</em>}</li>
 * </ul>
 * </p>
 * 

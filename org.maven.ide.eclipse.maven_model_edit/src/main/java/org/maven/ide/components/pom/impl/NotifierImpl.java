 ...
 * <ul>
 * <li>{@link org.maven.ide.components.pom.impl.NotifierImpl#getType <em>Type
 * </em>}</li>
 * <li>{@link org.maven.ide.components.pom.impl.NotifierImpl#getSendOnError <em>
 * Send On Error</em>}</li>
 * <li>{@link org.maven.ide.components.pom.impl.NotifierImpl#getSendOnFailure
 * <em>Send On Failure</em>}</li>
 * <li>{@link org.maven.ide.components.pom.impl.NotifierImpl#getSendOnSuccess
 * <em>Send On Success</em>}</li>
 * <li>{@link org.maven.ide.components.pom.impl.NotifierImpl#getSendOnWarning
 * <em>Send On Warning</em>}</li>
 * <li>{@link org.maven.ide.components.pom.impl.NotifierImpl#getAddress <em>
 * Address</em>}</li>
 * <li>{@link org.maven.ide.components.pom.impl.NotifierImpl#getConfiguration

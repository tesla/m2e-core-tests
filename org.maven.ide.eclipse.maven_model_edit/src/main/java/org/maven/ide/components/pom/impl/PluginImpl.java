 ...
 * <ul>
 * <li>{@link org.maven.ide.components.pom.impl.PluginImpl#getGroupId <em>Group
 * Id</em>}</li>
 * <li>{@link org.maven.ide.components.pom.impl.PluginImpl#getArtifactId <em>
 * Artifact Id</em>}</li>
 * <li>{@link org.maven.ide.components.pom.impl.PluginImpl#getVersion <em>
 * Version</em>}</li>
 * <li>{@link org.maven.ide.components.pom.impl.PluginImpl#getExtensions <em>
 * Extensions</em>}</li>
 * <li>{@link org.maven.ide.components.pom.impl.PluginImpl#getExecutions <em>
 * Executions</em>}</li>
 * <li>{@link org.maven.ide.components.pom.impl.PluginImpl#getDependencies <em>
 * Dependencies</em>}</li>
 * <li>{@link org.maven.ide.components.pom.impl.PluginImpl#getInherited <em>
 * Inherited</em>}</li>
 * <li>{@link org.maven.ide.components.pom.impl.PluginImpl#getConfiguration <em>
 * Configuration</em>}</li>
 * </ul>
 * </p>
 * 

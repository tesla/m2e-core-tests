 ...
 * <ul>
 * <li>{@link org.maven.ide.components.pom.impl.ProfileImpl#getId <em>Id</em>}</li>
 * <li>{@link org.maven.ide.components.pom.impl.ProfileImpl#getActivation <em>
 * Activation</em>}</li>
 * <li>{@link org.maven.ide.components.pom.impl.ProfileImpl#getBuild <em>Build
 * </em>}</li>
 * <li>{@link org.maven.ide.components.pom.impl.ProfileImpl#getRepositories <em>
 * Repositories</em>}</li>
 * <li>
 * {@link org.maven.ide.components.pom.impl.ProfileImpl#getPluginRepositories
 * <em>Plugin Repositories</em>}</li>
 * <li>{@link org.maven.ide.components.pom.impl.ProfileImpl#getDependencies <em>
 * Dependencies</em>}</li>
 * <li>{@link org.maven.ide.components.pom.impl.ProfileImpl#getReports <em>
 * Reports</em>}</li>
 * <li>
 * {@link org.maven.ide.components.pom.impl.ProfileImpl#getDependencyManagement
 * <em>Dependency Management</em>}</li>
 * <li>
 * {@link org.maven.ide.components.pom.impl.ProfileImpl#getDistributionManagement
 * <em>Distribution Management</em>}</li>
 * <li>{@link org.maven.ide.components.pom.impl.ProfileImpl#getProperties <em>
 * Properties</em>}</li>
 * <li>{@link org.maven.ide.components.pom.impl.ProfileImpl#getModules <em>
 * Modules</em>}</li>
 * <li>{@link org.maven.ide.components.pom.impl.ProfileImpl#getReporting <em>
 * Reporting</em>}</li>
 * </ul>
 * </p>
 * 

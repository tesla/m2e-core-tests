 ...
 * <ul>
 * <li>{@link org.maven.ide.components.pom.impl.ResourceImpl#getTargetPath <em>
 * Target Path</em>}</li>
 * <li>{@link org.maven.ide.components.pom.impl.ResourceImpl#getFiltering <em>
 * Filtering</em>}</li>
 * <li>{@link org.maven.ide.components.pom.impl.ResourceImpl#getDirectory <em>
 * Directory</em>}</li>
 * <li>{@link org.maven.ide.components.pom.impl.ResourceImpl#getIncludes <em>
 * Includes</em>}</li>
 * <li>{@link org.maven.ide.components.pom.impl.ResourceImpl#getExcludes <em>
 * Excludes</em>}</li>
 * </ul>
 * </p>
 * 
